  ...
  return (
    ...
    <div className={styles["main_container"]}>
      ...
      <div>
        ...
        <div className={styles["company_desc"]}>Funded by donations and operated by volunteers, our no-kill shelter homes over 300 cats and dogs.
    </div>
    </div>
    ...
    <div className={styles["subsection"]}>Locations</div>
       <p>
        <p style={{background:"#E8E8E8",color:"black",width:"fit-content",borderRadius:"5px"}}>Primary</p>
        Headquarters
        Dnipro, UA
       </p>
